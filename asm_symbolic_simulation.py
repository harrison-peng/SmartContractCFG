            ...
            for ins in ins_list:
                ...
                if opcode.split(' ')[0] == 'tag':
                    ...
                    state, ins_gas, path_constraint, gas_constraint, var_constraint, prev_jumpi_ins, next_jump_tag = \
                        asm_state_simulation.state_simulation(opcode, state, line, prev_jumpi_ins)
                    ...
                    if has_loop:
                        ...
                        gas_cons.add(asm_state_simulation.add_gas_constraint(new_var, UNSIGNED_BOUND_NUMBER))
